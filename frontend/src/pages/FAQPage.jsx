      ...
      <div className="mx-auto space-y-4">
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 2 && (
            <div className="mt-4">
              ...
              For items damaged during transit or quality issues To initiate a return, please email
                us at support@farmit.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@farmit.com, or by calling us at 1234-5678
        ...
        <div className="border-b border-gray-200 pb-4">
          ...
          {activeTab === 6 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                Currently, we only offer shipping within the Local Areas.
              </p>
            </div>
          )}
        </div>
